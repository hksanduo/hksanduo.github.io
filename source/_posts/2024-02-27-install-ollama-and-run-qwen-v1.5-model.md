...
![加载gemma](/img/20231211-01.png)

* 魔法上网，效果更好。

![加载成功](/img/20231211-02.png)

ollama会将缓冲保存到本地用户目录下：`~/.ollama/models` 文件保存类似于docker存储方式

![缓存](/img/20231211-03.png)
...
![cpu占用率](/img/20231211-04.png)

cover成功

![转换成功](/img/20231211-05.png)

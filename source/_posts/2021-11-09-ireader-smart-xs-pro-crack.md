...
### 2022年01月08日更新
网友@郎咸蒙 反馈软件安装完毕后，显示效果比较差，通过修改显示模式缓解，其他小伙伴遇到了类似的情况可以自行修改一下，另外该网友自建了一个代理服务器，自动化处理安装请求，有需要的小伙伴可以参考一下：[https://kikicoding.cn/ireadersmart2.html](https://kikicoding.cn/ireadersmart2.html) ,安全性和稳定性各位网友自行判断即可。

...
![20211108-01.png](/img/20211108-01.png)
...
![20211108-02.png](/img/20211108-02.png)
...
![20211108-03.png](/img/20211108-03.png)
/proc/23632/fd目录下发现关联的一些文件信息
![20211108-04.png](/img/20211108-04.png)
如果看过之前分析的第一篇文章，对 /tmp/.X11-unix/目录文件应该不陌生，里面的文件存储着远控和挖矿进程id信息。
![20211108-05.png](/img/20211108-05.png)

我们先将已删除的文件提取出来
![20211108-07.png](/img/20211108-07.png)

提交到virustotal分析，发现几天前应该是有人中招了。
![20211108-08.png](/img/20211108-08.png)

#### 远控
接下来轻车熟路，进入/tmp/.X11-unix/，查看其他进程信息。
![20211108-09.png](/img/20211108-09.png)
其中名为22的文件内容为空，不清楚原因，出了挖矿的，另一个名为01的文件，应该存储着远控的进程id，这里是22545。
![20211108-10.png](/img/20211108-10.png)
同样的配方，导出远控的进程
![20211108-11.png](/img/20211108-11.png)

#### 其他
通过仔细查找，发现root目录下存在两个可疑文件：
![20211108-12.png](/img/20211108-12.png)

* .systemd-private-a7sebNyLZedpFNW6SxqOF2F7ggZv2te.sh
* .unixdb.sh

.systemd-private-a7sebNyLZedpFNW6SxqOF2F7ggZv2te.sh脚本内容如下：
![20211108-13.png](/img/20211108-13.png)
文本内容如下：
```
 #!/bin/bash
exec &>/dev/null
...
```
.unixdb.sh内容如下：
![20211108-14.png](/img/20211108-14.png)
文本内容如下：
```
#!/bin/bash
exec &>/dev/null
...
![20211108-20.png](/img/20211108-20.png)

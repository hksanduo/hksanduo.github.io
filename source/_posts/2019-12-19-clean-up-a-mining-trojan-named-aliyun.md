...
![20191219-trojan-05.png](/img/20191219-trojan-05.png)
解码以后的内容如下：
```
exec & > /dev/null
...
![20191219-trojan-06.png](/img/20191219-trojan-06.png)
...
crn检测结果：
![20191219-trojan-17.png](/img/20191219-trojan-17.png)
int检测结果：
![20191219-trojan-18.png](/img/20191219-trojan-18.png)
返现int木马程序主体，crn为shell文件，目的是下载int木马程序并运行，crn文件并未进行编码和混淆，不太清楚作者为何这么做。
![20191219-trojan-19.png](/img/20191219-trojan-19.png)
将int扔到IDA并未发现什么，只发现基本的逻辑流程，可能个人逆向功底太弱了，那位大佬分析了，可以请教一下。
![20191219-trojan-20.png](/img/20191219-trojan-20.png)
...
![20191219-trojan-07.png](/img/20191219-trojan-07.png)
可以发现相应的远控客户端（/usr/bin/46e5166a46208402e09732a78526b5f0）已删除
使用top我们可以发现，该挖矿木马的客户端的进程id为8391，
![20191219-trojan-08.png](/img/20191219-trojan-08.png)
通过查看`/tmp/.X11-unix/00`文件，获取对应远控客户端进程id为**8065**
![20191219-trojan-09.png](/img/20191219-trojan-09.png)
通过pstree，我们可以清晰的看到两个异常的进程**OYK6yV**和 **jKhnvF**
![20191219-trojan-10.png](/img/20191219-trojan-10.png)
通过分析`ps -ef`的结果，获取异常异常进程信息
![20191219-trojan-11.png](/img/20191219-trojan-11.png)
综合所有信息，我们发现jKhnvF是挖矿进程，OYK6yV是木马远控的进程。

## 移除挖矿木马
分析完挖矿木马基本信息，接下来我们需要移除这些恶意的进程，并针对相关漏洞进行打补丁。
我们首先移除了crotab中设定的定时任务
![20191219-trojan-12.png](/img/20191219-trojan-12.png)
然后杀掉两个恶意进程
![20191219-trojan-13.png](/img/20191219-trojan-13.png)
...
![20191219-trojan-14.png](/img/20191219-trojan-14.png)
我们通过移除两个定时任务，然后重复上面的操作，找到挖矿端和木马远控客户端，杀掉就行
![20191219-trojan-15.png](/img/20191219-trojan-15.png)
清除`/root/.aliyun.sh`和`/opt/aliyun.sh`
看着运行正常的系统，内心还是很满足的。
![20191219-trojan-16.png](/img/20191219-trojan-16.png)
